...
const router_2 = require("./routes/posts/router");
...
const router_6 = require("./routes/products/router");
...
app.use('/api/posts', router_2.routerPosts);
...
app.use('/api/products', router_6.routerProducts);
